...
| `DEFAULT_QUERY_LIMIT`      | The default query limit used when not defined in the API request.                                          | `100`         |
| `MAX_QUERY_LIMIT`          | The maximum query limit accepted on API requests.                                                          | `-1`          |
